...
function end() {
  ...
  window.location.replace(`https://app.thecodeblueapp.com/mobiledata?${data}`);
}
...
function startmessage(){
  data += `${getpreview()}_`;
  localdata += `${getstart()} \n`;
  document.getElementById("b1").style.backgroundColor="#2cccc4";
  text1.innerHTML = 'Okay to administer medication';
 }
...
function t1(info) {
  if (info == 'okay') {
    ...
    text1info = 2;
    document.getElementById("b1").style.backgroundColor="#db545a";
    text1.innerHTML = 'Wait to administer medication';
  }
}
...
function t2(info) {
  if (info == 'okay') {
    text2info = 1;
    document.getElementById("b2").style.backgroundColor="#2cccc4";
    text2.innerHTML = 'Ready for pulse check';
  }
  else if (info == 'no') {
    text2info = 2;
    document.getElementById("b2").style.backgroundColor="#db545a";
    text2.innerHTML = 'Continue compressions at &gt; 100 per minute';
  }
}